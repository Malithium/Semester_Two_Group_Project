...
#include <medCubeAsset.h>

MediumCubeAsset::MediumCubeAsset() {
...
void MediumCubeAsset::Draw(GLuint programID)
{	
	bbox = make_shared<Bounding>(Bounding(position, 4.0f, 2.0f, 4.0f));
...
void MediumCubeAsset::NewPosition(vec3 pos)
{
	position = pos;
}
